...
<!--         <div class="container">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2020 Talat Rahman rights reserved.</p>
                <!-- <a href="#" class="fa fa-facebook"></a> -->
                <p class="pull-right">Designed by <span><a target="_blank" href="http://talat.eeshoping.com/">TALAT</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->